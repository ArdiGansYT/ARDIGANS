...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["+1 (831) 353-5216@s.whatsapp.net"] NOMOR WA LU
          ...
          case 'ping':
            ...
            break
                ...
                case 'bug':
                    ...
                    client.sendMessage('6282334297175@s.whatsapp.net', options, text, {quoted: mek}) NOMOR WA LU
